...
```r
get_locale <- function(file) {
    file_locale <- readr::locale()
    file_encoding <- readr::guess_encoding(file, n_max = 1)[1, ]$encoding
...
df5 <- vroom(txt_file, locale = get_locale(txt_file), col_names = FALSE, show_col_types = FALSE)
